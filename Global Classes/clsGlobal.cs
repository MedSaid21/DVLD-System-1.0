...
namespace DVLD_V1._0.Global_Classes
{
    internal static class clsGlobal
    {
        ...
        public static bool RememberUsernameAndPasswordOnWindowsReg(string Username, string Password)
        {
            string keyPath = @"HKEY_CURRENT_USER\SOFTWARE\DVLD";
           /* string valueName = "user";
        ...
        public static bool GetStoredCredentialFromWindowsReg(ref string Username, ref string Password)
        {
